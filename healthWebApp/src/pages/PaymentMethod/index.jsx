  ...
  return (
    <main className='PaymentMethod'>
      <div className="PaymentMethod__topBar">
        <button className="PaymentMethod__backButton" onClick={() => navigate('/payment-validation')}>
          <IoIosArrowBack />
        </button>
      ...
      <section className='PaymentMethod__container'>
        ...
        <div className='PaymentMethod__container-dataPay'>
          ...
          <button className='PaymentMethod__container-Btn' onClick={() => navigate('/successfull-payment')}>Continuar</button>
        </div>
      </section>
      <Footer />
    </main>
